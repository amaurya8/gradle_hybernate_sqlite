...
It will respond with a JSON representation of a greeting, as the following listing shows and FINALY Loads this Greeting messages to sql_lite database. 

# This project helps to build utility where we can extract data from rest end point, map it to pojo and then using hibernate load it to any database, that way we can create our own data-mart.
...
Thanks For Reading / Using - Ashok Maurya
